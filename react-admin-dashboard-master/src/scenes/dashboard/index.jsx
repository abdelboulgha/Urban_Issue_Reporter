...
const Dashboard = () => {
  ...
  const getAdminsCount = async () => {
    await axios
      .get(`https://urbanissuereporter-86jk0m0e.b4a.run/api/admins-count/`)
      .then((response) => {
        setTotalAdmins(response.data.data.totalAdmins);
      })
      .catch((error) => {
        console.error(
          "Erreur lors de la récupération du nombre d'admins :",
          error
        );
      });
  };
  ...
  const getCitoyensCount = async () => {
    await axios
      .get("https://urbanissuereporter-86jk0m0e.b4a.run/api/citoyens-count")
      .then((response) => {
        setTotalCitoyens(response.data.data.totalCitoyens);
      })
      .catch((error) => {
        console.error(
          "Erreur lors de la récupération du nombre d'citoyens :",
          error
        );
      });
  };
  ...
  const getReclamationsCount = async (id) => {
    await axios
      .get(
        `https://urbanissuereporter-86jk0m0e.b4a.run/api/reclamations-count/${id}`
      )
      .then((response) => {
      ...
      .catch((error) => {
        console.error(
          "Erreur lors de la récupération du nombre d'reclamations :",
          error
        );
      });
  };
  ...
  const getUrgentsReclamations = async (id) => {
    await axios
      .get(
        `https://urbanissuereporter-86jk0m0e.b4a.run/api/urgents-reclamations/${id}`
      )
      .then((response) => {
      ...
      .catch((error) => {
        console.error(
          "Erreur lors de la récupération du nombre d'regions :",
          error
        );
      });
  };
  ...
  const getRegionsCount = async () => {
    await axios
      .get("https://urbanissuereporter-86jk0m0e.b4a.run/api/regions-count")
      .then((response) => {
          ...
          >
            <CardContent sx={{ p: 3, height: "100%" }}>
              ...
              <Divider
                sx={{
                  mb: 3,
                  backgroundColor: alpha(colors.greenAccent[500], 0.3),
                }}
              />
              <Box
                height="85%"
                    ...
                    >
                      <Stack spacing={1}>
                        ...
                        <Stack direction="row" spacing={1} alignItems="center">
                          <PlaceIcon
                            sx={{ color: colors.grey[300], fontSize: "16px" }}
                          />
